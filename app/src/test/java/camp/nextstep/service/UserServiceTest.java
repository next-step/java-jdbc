...
class UserServiceTest {
    ...
    void testChangePassword() {
        ...
        final var userService = new TxUserService(new AppUserService(userDao, userHistoryDao), dataSource, new TransactionHandler());
    ...
    void testTransactionRollback() {
        ...
        // 트랜잭션 서비스 추상화
        final var userService = new TxUserService(appUserService, dataSource, new TransactionHandler());
