...
class UserServiceTest {
    ...
    void setUp() {
        ...
        this.transactionalManager = new PlatformTransactionalManager(dataSource);
    ...
    void testChangePassword() {
        ...
        final var userService = new UserService(userDao, userHistoryDao, transactionalManager);
